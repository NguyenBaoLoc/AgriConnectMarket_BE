...
namespace AgriConnectMarket.Application.Interfaces
{
    public interface IOrderRepository : IRepository<Order>
    {
        ...
        public Task<IEnumerable<Order>> GetPreOrdersByFarmIdAsync(Guid farmId, bool includeItems = false, bool includepPreOrder = false, bool includeProfile = false, CancellationToken ct = default);
        ...
        public Task<Order> GetByPreOrderCodeAsync(string orderCode, bool includeItems = false, bool includepPreOrder = false, bool includeProfile = false, CancellationToken ct = default);
